...
app.get('/player_info/post', function(req, res) {
  var get_var = req.query.player_choice;

  var query1 = 'select id, name from football_players';
  var query2 = 'select * from football_players where id = ' + get_var ;
  var query3 = 'select count(*) as games_played from football_players inner join football_games'
  db.task('get-everything', task => {
    return task.batch([
      task.any(query1),
      task.any(query2),
